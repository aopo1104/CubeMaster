...
(function () {
  ...
  function skuRowHtml(d) {
    return '<td><input value="'+d.name+'"/></td>'
      ...
      +'<option value="OrientationsAll"'+(d.orient==='OrientationsAll'?' selected':'')+'>模式1：全方向（最灵活）</option>'
      +'<option value="Orientations12"'+(d.orient==='Orientations12'?' selected':'')+'>模式2：12方向（高装载优先）</option>'
      +'<option value="Orientations14"'+(d.orient==='Orientations14'?' selected':'')+'>模式3：2方向（更稳）</option>'
      +'<option value="Orientation1"'+(d.orient==='Orientation1'?' selected':'')+'>模式4：固定方向（不旋转）</option>'
      +'</select></td>'
